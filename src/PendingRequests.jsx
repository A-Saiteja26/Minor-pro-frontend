...
function PendingRequests() {
    ...
    const fetchPendingRequests = async () => {
        try {
            const response = await axios.get('https://minor-proj-liveness.onrender.com/myapp/admin/view-requests');
    ...
    const handleAcceptAll = async() =>{
        try {
            ...
            const response=await axios.post('https://minor-proj-liveness.onrender.com/myapp/admin/accept', { ids: selectedRequests});
    ...
    const handleRejectAll = async() => {
        try {
            ...
            const response=await axios.post('https://minor-proj-liveness.onrender.com/myapp/admin/reject', { ids: selectedRequests});
            console.log('Request accepted');
            fetchPendingRequests()
            console.log(JSON.stringify(response))
        ...
        const handleSubmit = async (action,request) => {
            ...
            try {
                ...
                if (action === 'accept') {
                    ...
                    const response=await axios.post('https://minor-proj-liveness.onrender.com/myapp/admin/accept', { ids: [request]});
                    console.log('Request accepted');
                    ...
                    const response=await axios.post('https://minor-proj-liveness.onrender.com/myapp/admin/reject', { ids: [request]});
                    console.log(JSON.stringify(response))
